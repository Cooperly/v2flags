...
Anybody administrating a pterodactyl panel instance (NOT CUSTOMERS OF A HOST), and wanting the performance improvements from [v2flags](https://github.com/Cooperly/v2flags) in a sleek interface rather than using docker-compose or running a server bare metal
<br>
<br>
This repo clears a few optimizations that pterodactyl doesn't like, additionally you have to use a specific docker image, some pre-made eggs are ready (soon) if your lazy
<br>
If your all in for performance, Run the actual [v2flags](https://github.com/Cooperly/v2flags) bare metal or at least with docker-compose, not this.

# Heads Up
Do not rely on these flags as your only source of optimization, yes they could theoretically increase your performance up to 50%, but to be brutally honest it's snake oil compared to optimizing your server properly, use this as a cherry on top in terms of performance, not your entire optimization
